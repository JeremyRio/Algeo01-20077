public class SPL {
    ...
    /* =============== MATRIKS BALIKAN ============== */
    /* Menghasilkan solusi SPL dengan metode Inverse */
    ...
    /* =============== CRAMER ============== */
    /* Menghasilkan solusi SPL dengan metode Cramer */
    ...
    public static Matrix getRowEchelon(Matrix M) {
        ...
        for (i = 0; i < M.getRow(); i++) {
            colSwitch = 0;
            switchFlag = true;
            // Jika elemen diagonal matriks 0 atau lebih dari 1, harus di tukar dengan baris
            // yang tidak nol di kolom yang sama
    ...
    // Fungsi untuk menghasilkan array pecahan sebuah parametrik, contoh 8.00p
    // dipecah menjadi [8.00, p]
    public static String[] stripNonDigits(String x) {
        final String[] out = new String[2];
        // Membuat sebuah string builder dengan kapasitas panjang x, kalau x = 8.00p,
        // maka panjangnya 5
    ...
    public static void getGaussSolutions(Matrix M) {
                        ...
                        if (state[j] == 2) {
                            ...
                            if (M.getELMT(i, j) > 0) {
                                if (Math.abs(M.getELMT(i, j)) == 1) {
                                    ...
                                    // Coba untuk mendapatkan perkalian substitusi, misal x3 = -2q dan x1 = 2x3,
                                    // maka x1 = 2(-2q) = -4q
                                    try {
        ...
        IOFile.saveFileParametric(M.getCol() - 1, Eq);
    }
}